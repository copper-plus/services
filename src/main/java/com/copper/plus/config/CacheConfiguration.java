package com.copper.plus.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.copper.plus.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.copper.plus.repository.UserRepository.USERS_BY_EMAIL_CACHE);
